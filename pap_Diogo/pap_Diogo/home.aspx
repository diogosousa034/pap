...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <h1 class="display-6 mt-4 text-center">home page</h1>
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-center">
            <div class="d-flex">
                ...
                <div>
                    <asp:DataList ID="DataListAnimais" runat="server" DataKeyField="ID_animal" RepeatColumns="3" RepeatDirection="Horizontal" CellPadding="20" Height="250px" Width="300px">
                        <ItemTemplate>
